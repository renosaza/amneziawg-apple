...
grep -Fq -- '--allow-route-plan-network-rebind' "$installer"
...
grep -Fq -- '-manual-route-plan-stop-three' "$workflow"
grep -Fq -- '-manual-route-plan-assert-one-three' "$workflow"
grep -Fq '[[ $first_interface != "$second_interface" ]]' "$workflow"
grep -Fq '[[ $first_interface != "$third_interface" ]]' "$workflow"
grep -Fq '[[ $second_interface != "$third_interface" ]]' "$workflow"
